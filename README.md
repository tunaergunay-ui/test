...
- Immutable events now include structured metadata (e.g., state transitions and due-date changes) that is serialized in timeline API responses and protected by the hash chain
