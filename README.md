...
- Finding-level timeline retrieval from immutable audit events (optional validated+trimmed string event-type filter, strict positive integer limit, and non-negative offset)
